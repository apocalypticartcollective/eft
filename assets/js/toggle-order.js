...
// - Button text shows the action (what will happen when clicked): "(Show me: newest to oldest)" when currently oldest-first, and vice versa.
...
(function () {
  ...
  function setButtonText() {
    ...
    // If currently asc (oldest first), clicking will make it desc (newest first)
    // If currently desc (newest first), clicking will make it asc (oldest first)
